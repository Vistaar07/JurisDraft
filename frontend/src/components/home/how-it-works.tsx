...
const steps: Step[] = [
  {
    ...
    description:
      "Upload your requirements and reference documents. Our system accepts multiple formats and extracts key information instantly.",
  },
  {
    icon: <BrainCircuit size={64} strokeWidth={1.5} />,
    label: "Content Generation",
    description:
      "Our custom RAG model analyzes legal corpus and generates precise, context-aware documents tailored to your specific needs.",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: "Document Export",
    description:
      "Download your professionally formatted legal document as a PDF, ready for review, signing, and immediate use.",
  },
];
...
export default function HowItWorksSection() {
  return (
    <section className="relative overflow-hidden bg-gray-50">
      <div className="py-8 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          aria-hidden="true"
        ...
        <div className="text-center mb-16">
          ...
          >
            Generate professional legal documents in three intelligent steps
          </MotionH3>
        </div>
