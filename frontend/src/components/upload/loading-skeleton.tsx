        ...
        <div className="px-6">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((_, index) => (
              <div
                key={`numbered-${index}`}
                className="group relative bg-linear-to-br from-gray-500/8 to-gray-600/3 p-4 rounded-2xl border border-gray-500/10"
              >
            ...
            {[1, 2].map((_, index) => (
              <div
                key={`emoji-${index}`}
                className="group relative bg-linear-to-br from-gray-200/8 to-gray-400/3 p-4 rounded-2xl border border-gray-500/10"
              >
