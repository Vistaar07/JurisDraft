...
export function BackgroundCircles({
  ...
  description = "Stop wrestling with templates. JurisDraft uses advanced AI to analyze your needs and generate precise, professional legal documents in minutes.",
  className,
  variant = "octonary",
  children,
